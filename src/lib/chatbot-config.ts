...
export const defaultChatBotConfig: ChatBotConfig = {
  ...
  ui: {
    ...
    welcomeMessage: '¡Hola! 👋\n\nBienvenido a Cremería Raíz. ¿En qué podemos ayudarte hoy?\nPregúntanos por quesos, yogures o cualquier producto artesanal.',
    placeholderText: 'Escribe tu mensaje sobre productos, pedidos o dudas...'
  },
  features: {
  ...
  branding: {
    name: 'Cremería Raíz',
    avatar: '/images/queso.jpg',
    description: 'Atención personalizada y productos frescos de Oaxaca.'
  }
};
