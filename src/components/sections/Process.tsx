        ...
        >
          ...
          <motion.div variants={itemVariants} className="relative">
            <div className="relative max-w-4xl mx-auto">
              ...
              {/* Decorative elements (ahora imágenes de productos) */}
              <Image src="/images/queso.jpg" alt="Queso decorativo" width={96} height={96} className="absolute -top-4 -left-4 rounded-full opacity-20 blur-xl" />
              <Image src="/images/quesillo.jpg" alt="Quesillo decorativo" width={128} height={128} className="absolute -bottom-4 -right-4 rounded-full opacity-10 blur-xl" />
            </div>
          </motion.div>
